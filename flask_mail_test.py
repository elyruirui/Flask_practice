...
app.config['MAIL_USERNAME'] = '2789136271@qq.com'  # 填邮箱
app.config['MAIL_PASSWORD'] = 'ghhfpegapzjxdgeg'      # 填授权码
app.config['MAIL_DEFAULT_SENDER'] = '2789136271@qq.com'  # 填邮箱，默认发送者
manager = Manager(app)
mail = Mail(app)
